...
import com.prasthaan.dusterai.ImagePreviewActivity;
...
public class AdapterHistory extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ArrayList<ModalHistory> list;
    Context context;

    public AdapterHistory(ArrayList<ModalHistory> list, Context context) {
        this.list = list;
...
//            AdLoader adLoader = new AdLoader.Builder(context, development_test_ad) // test ad
            ...
            ModalHistory model = list.get(position);
            FeatureViewHolder featureHolder = (FeatureViewHolder) holder;
            Glide.with(context)
                    .load(model.getImagePath()) // Can be a file path or URL
//                    .placeholder(R.drawable.placeholder_image) // optional: show a placeholder
                    .into(((FeatureViewHolder) holder).imageView); // your ImageView reference
            featureHolder.textViewFileName.setText(model.getFileName());
            featureHolder.textViewDate.setText(model.getDateTime());
...
//            adContainer = itemView.findViewById(R.id.native_ad_container);
    ...
    public static class FeatureViewHolder extends RecyclerView.ViewHolder {
        ImageView imageView;
        TextView textViewFileName, textViewDate;

        public FeatureViewHolder(@NonNull View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.history_image);
            textViewFileName = itemView.findViewById(R.id.history_filename);
